...
HD_PWD='D:/project/Code/Task1_folder/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finalgcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finalgcd.tcl
