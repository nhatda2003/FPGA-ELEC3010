proc create_ipi_design { offsetfile design_name } {
	...
	set final_0 [ create_bd_cell -type ip -vlnv vinuni.local:user:final:1.0 final_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores vinuni.local:user:final:1.0]]]]
